...
export const teamKitColors: TeamColors = {
  ...
  "Arsenal": {
    ...
    goalkeeper: { primary: "#7EBAA1", secondary: "#000000", accent: "#FFFFFF" }
  },
  "Real Madrid": {
    ...
    goalkeeper: { primary: "#44C7FF", secondary: "#000000", accent: "#FFFFFF" }
  },
  "Paris SG": {
    ...
    goalkeeper: { primary: "#FFC61E", secondary: "#000000", accent: "#FFFFFF" }
  },
  "Inter": {
    ...
    goalkeeper: { primary: "#FDB022", secondary: "#000000", accent: "#FFFFFF" }
  },
  "Barcelona": {
